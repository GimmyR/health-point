...
export default function PatientInfo({ isStaff, id, room, diagnosis } : Props) {
    return <>
        <ul style={{ listStyleType: "none" }} className="text-lg-end px-0 mb-2">
            <li>
                <span className="fw-bold">Room :</span> {room}
            </li>
            <li>
                <span className="fw-bold">Diagnosis :</span> {diagnosis}
            </li>
        </ul>
